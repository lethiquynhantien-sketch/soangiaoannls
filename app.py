...
<div class="main-header">
    ...
    <p>Tác giả: Lê Thị Quỳnh - Trường Tiểu học Hùng An - ĐT: 038 6691 629</p>
</div>
""", unsafe_allow_html=True)
...
# --- CHÂN TRANG ---
st.markdown("---")
st.markdown("<div style='text-align: center; color: #666;'>© 2025 - Lê Thị Quỳnh - Trường Tiểu học Hùng An - ĐT: 038 6691 629</div>", unsafe_allow_html=True)
